...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.comboBox_label, 1, 5, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=Dialog)
        self.label_6.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.gridLayout.addWidget(self.label_6, 1, 2, 1, 1)
        self.comboBox_conf = QtWidgets.QComboBox(parent=Dialog)
        self.comboBox_conf.setObjectName("comboBox_conf")
        self.gridLayout.addWidget(self.comboBox_conf, 1, 3, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "Signal Confidence"))
